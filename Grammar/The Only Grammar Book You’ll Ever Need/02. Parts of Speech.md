...
* Indefinite pronouns (不定代名詞):
	...
	* Contrary to the word "indefinite", they sometimes refer to a definite ones that has already been mentioned in the sentence. 
		* **all, any, most, none, and some** sometimes are singular and sometimes are plural. 
...
* Coordinating Conjunctions (對等連接詞): **but, or, yet, so, for, and, nor (fanboys)**
...
* What is the difference between **coordinating conjunctions** and **subordinating conjunctions**? A coordinating conjunction used to join clauses of **equal importance**; A subordinating conjunction joins and it **shows a relationship** between the clauses that it joins